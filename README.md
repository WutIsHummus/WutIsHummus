...
**Side:** Roblox Studio Developer, 1M+ user game, peak 600 CCU <br>
**Previous:** Fullstack Intern @ Lockheed Martin <br>
**Website:** [alperenaydin.tech](https://alperenaydin.tech) <br>
...
> `Yocto` &middot; `Linux` &middot; `Raspberry Pi CM5` &middot; `Embedded`
### [Rorchestra](https://github.com/WutIsHummus/Rorchestra)
...
> `Python` &middot; `Gemini CLI` &middot; `MCP` &middot; `SQLAlchemy` &middot; `Rojo`
### [FreshRoles](https://github.com/WutIsHummus/FreshRoles)
...
> `Python` &middot; `Playwright` &middot; `Ollama` &middot; `SQLite` &middot; `ntfy`
